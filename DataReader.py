...
#Images path
c_root = '/content/drive/MyDrive/Programas/Images/COVID-19/covidp'
n_root = '/content/drive/MyDrive/Programas/Images/Normal/normalp'
p_root = '/content/drive/MyDrive/Programas/Images/Pneumonia/pneumoniap'
